...
function sample_params()
	par_vec = (2:2:100,40:20:500)
	argnames = (:n_bins, :n_random_cuts)
...
function create_space()
    ...
    (;
    n_bins        = pyInt(1, 256,                          name="n_bins"),
    n_random_cuts = pyInt(1, 500,                          name="n_random_cuts"),
    )
end
function fit(data, parameters)
	# construct model - constructor should only accept kwargs
	model = GenerativeAD.Models.LODA(;parameters...)
