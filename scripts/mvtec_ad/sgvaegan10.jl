...
function fit(data, parameters, save_parameters, seed)
    ...
    try
         global info, fit_t, _, _, _ = @timed fit!(model, data[1][1]; 
            max_train_time=20*3600/max_seed, workers=4, val_samples=1000,
...
if abspath(PROGRAM_FILE) == @__FILE__
    ...
    while try_counter < max_tries
        ...
        for seed in 1:max_seed
            ...
            data = GenerativeAD.Datasets.normalize_data(data, true)
            ...
            if GenerativeAD.check_params(savepath, edited_parameters)
                # fit
                # these parameters will be used in the savename
