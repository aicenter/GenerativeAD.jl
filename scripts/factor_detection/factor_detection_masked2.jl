...
mainpath = datadir("sgad_models/images_leave-one-in/$(modelname)_retrained/$dataset/ac=$ac/seed=1/")
...
model.model.eval();
outdir = datadir("factor_identification/prediction_masked2/$modelname/$dataset/ac=$ac/seed=1")
