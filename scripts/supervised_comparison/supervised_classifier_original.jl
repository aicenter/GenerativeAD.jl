# this is meant to compute the performance of a supervised classifier that is trained, validated and tested
# on the original setup of the data liek in image_experiments
using DrWatson
@quickactivate
using GenerativeAD
using PyCall
...
@add_arg_table! s begin
    ...
    "anomaly_class"
    	default = 0
    	arg_type = Int
    	help = "anomaly class - that is the index of class of normal data"
end
...
function experiment(dataset, ac, seed, save_dir)
	...
	(tr_x, tr_y), (tst_x, tst_y) = data[2], data[3]
