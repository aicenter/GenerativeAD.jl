...
if [ "$DATASET_TYPE" == "tabular" ]; then
    models=("GANomaly" "MAF" "MO_GAAL" "RealNVP" "aae" "aae_vamp" "abod" "adVAE" "fmgan" "gan" "hbos" "if" "knn" "loda" "lof" "ocsvm" "pidforest" "sptn" "vae" "wae" "wae_vamp")
    ...
    models=("Conv-GANomaly" "Conv-SkipGANomaly" "aae" "fmgan" "knn" "ocsvm" "vae" "wae")
